...
export default function PrivacyPage() {
  return (
    <LegalShell
      ...
      intro="Esta política explica, en lenguaje simple, qué datos usa RevisaMiCV para analizar una vacante, generar tu CV adaptado y recuperar tus créditos/resultados."
    >
      <LegalSection title="Qué información usamos">
        <p>Para prestar el servicio podemos procesar: tu email, el CV que subes o pegas, la vacante que quieres analizar, el idioma elegido, el resultado generado, historial de análisis y datos mínimos de pago enviados por Stripe para acreditar créditos.</p>
      </LegalSection>
      <LegalSection title="Para qué usamos tus datos">
        <p>Usamos la información para comparar tu CV contra una vacante específica, generar un diagnóstico, crear un CV adaptado descargable, guardar tu historial y asociar créditos/compras a tu email.</p>
      ...
      <LegalSection title="Pagos y créditos">
        <p>Los pagos se procesan mediante Stripe. RevisaMiCV no guarda los datos completos de tu tarjeta. Usamos la confirmación de Stripe para acreditar créditos al email de compra.</p>
      </LegalSection>
      ...
      <LegalSection title="Tus derechos">
        <p>Puedes pedir acceso, corrección o eliminación de tus datos escribiendo a soporte con el email usado en la plataforma. Si pagaste y no ves créditos, usa ese mismo email para conciliación manual.</p>
      </LegalSection>
