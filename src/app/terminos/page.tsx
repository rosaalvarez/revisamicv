...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      intro="Estos términos definen el uso básico del producto: análisis CV + vacante, tokens, descargas y límites honestos de la herramienta."
    >
      ...
      <LegalSection title="Tokens y pagos">
        <p>Cada token equivale a un análisis de CV contra una vacante. Los tokens no son suscripción mensual y quedan asociados al email usado en Stripe/RevisaMiCV.</p>
        <p>Si Stripe confirma el pago pero los tokens no aparecen, debes usar el mismo email de compra en el dashboard o contactar soporte para conciliación manual.</p>
      </LegalSection>
      <LegalSection title="Errores y reembolsos">
        <p>Si un pago se duplica, no se acredita correctamente o ocurre un error técnico verificable, revisaremos el caso manualmente. Podemos acreditar tokens pendientes o evaluar reembolso según el caso y la evidencia de pago.</p>
      </LegalSection>
      ...
      <LegalSection title="Soporte">
        <p>Para soporte, escribe con el email usado en la plataforma y, si aplica, el email de pago de Stripe. Esto nos permite ubicar tus tokens e historial sin pedir datos innecesarios.</p>
      </LegalSection>
    </LegalShell>
  )
}
